...
SECRET_KEY = 'django-insecure-%-o09f+tac1=5b&m5pxr(dk=+$q_2uq0!*@rniqo_kmtr0fesi'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(TEMPLATES_DIR, 'core', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
GRAPPELLI_ADMIN_TITLE = "DJ RestFramework"